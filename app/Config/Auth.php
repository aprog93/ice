...
class Auth extends ShieldAuth
{
    ...
    public array $views = [
        ...
        'add_user'                    => '\CodeIgniter\Shield\Views\add_user',
    ...
    public function registerRedirect(): string
    {
     ...
     /**
     * Returns the URL the user should be redirected to
     * after a successful added user.
     */
    public function addUserRedirect(): string
    {
        $url = setting('Auth.redirects')['add_user'];
