            ...
            <div class="modal-body p-4 pt-3 pb-3">
                ...
                <form  action="add_user" method="post">
                    ...
                    <div class="col-m-12 mb-2">                        
                        <input type="username" name="username" class="form-control rounded-3" id="username" value="<?= set_value('username') ?>" placeholder="Usuario" required>                        
                    ...
                    <div class="col-md-12 mb-2">                        
                        <input type="password"name="password" class="form-control rounded-3" id="password" value="<?= set_value('password') ?>" placeholder="Contraseña" required>                        
                        <div class="invalid-feedback">
