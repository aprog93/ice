...
<div class="" id="success" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="successLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-custom my-0">
                    <h5 class="modal-title fs-5" id="successLabel">Insertar colaborador</h5>
                </div>
    ...
    <div class="modal fade" id="error" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="errorLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-custom my-0">
                    <h5 class="modal-title fs-5" id="errorLabel">Insertar colaborador</h5>
                </div>
                <div class="modal-body">
                    <div class="d-flex align-items-center py-1">
                        <div class="mx-1">
