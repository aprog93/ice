...
<div class="d-flex align-items-center">
    ...
    <div class="rounded-2 mx-auto align-items-center shadow col-4">
        ...
        <div class="p-3 border-bottom-1 bg-custom rounded-top-2 rouded-end-2">
            <h1 class="h5 m-0">Importar Datos</h1>
        </div>
        <div class="p-3">
            ...
            <form class="row gx-3 gy-2 align-items-center" action="<?= base_url("sistema/bd/importdata") ?>" method="post" enctype="multipart/form-data">

                <div class="col-12">
                    <div class="d-flex border rounded-2 info">
                        <div class="me-2">
                        ...
                        <span>Para evitar posibles errores, no modificar los nombres de los archivos originales a importar ni encabezados de columnas.</span>
                    </div>
                </div>
                <!-- </div> -->

                <div class="col-12">
                    <label for="fila" class="form-label">Datos a importar:</label>
