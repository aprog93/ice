...
<div class="d-flex align-items-center">
    ...
    <div class="rounded-2 mx-auto align-items-center shadow col-4">
        ...
        <div class="p-3">
            ...
            <form class="row gx-3 gy-2 align-items-center" action="<?= base_url("sistema/bd/import") ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="col-6">
                    <div class="d-flex border rounded-2 info">
                        ...
                        <span>Formato correcto de fecha en la BD: <strong><?= esc($formato) ?></strong>.</span>
                    </div>
                </div>
                <!-- </div> -->
